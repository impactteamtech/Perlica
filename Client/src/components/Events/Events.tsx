...
const Events = (): JSX.Element => {
  ...
  return (
    <section className="flex flex-col gap-8 py-10 mb-3 relative overflow-hidden">
      <h1 className="text-4xl lg:text-5xl xl:text-6xl text-center color-primary font-mono title-font leading-tightmb-6  z-50">ADVENTURE AND NATURE ACTIVITIES</h1>
