...
const HistoryAndMission = (): JSX.Element => {
  return (
    <div className="flex flex-col gap-10 background-color min-h-screen py-10 px-4 md:px-15 mt-18">
      {/* div 1 */}
     <div className="flex gap-3">
        <div className="w-[50%] flex-col gap-4 flex">
          <h1 className="color-primary text-6xl font-medium title-font">WE'RE DEDICATED TO MAKE EVERY JOURNEY EXCEPTIONAL</h1>
          <p className="text-xl font-text text-black/70">
            Established in <span>2007</span>, We deliver high-quality travel services through a
