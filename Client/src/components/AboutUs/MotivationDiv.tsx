...
const MotivationDiv = ():JSX.Element => {
  return (
    <div className="relative w-[50%] h-75 rounded-2xl  card-background-color p-6 flex flex-col">
      ...
      <div className="absolute left-40 bottom-20 z-100 w-[100%] pointer-events-none select-none">
          <img
            src="/kenya_airplane.png"
            alt="air-plane"
            className="w-full drop-shadow-xl animate-[float_6s_ease-in-out_infinite]" />
        </div>
      <style>{`
